...
/* ArgumentOptions -- a small wrapper holding the commonly used argument options */
struct ArgumentOptions {
    static constexpr std::string_view kExecutablePath = "--executable-path";   // path to risc-v elf executable
    static constexpr std::string_view kMaxInstructions = "--max-instructions"; // max instructions to execute
    static constexpr std::string_view kMaxStackBytes = "--max-stack-bytes";    // max size of call stack in bytes
};
